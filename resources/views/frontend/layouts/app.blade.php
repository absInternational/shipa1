        ...
        $(document).ready(function () {
            function setupIntlTelInput(e, n, t, o) {
                ...
                e.addEventListener("input", function () {
                    ...
                    let phoneValue = e.value.replace(/\D/g, ""); // Remove non-numeric characters
                    let areaCode = phoneValue.substring(0, 3); // Get first 3 digits

                    if (phoneValue.length >= 3 && !allowedPrefixes.includes(areaCode)) {
                        e.classList.add("error");
                        alert(`Invalid area code: ${areaCode}. Please enter a valid US number.`);
                    } else {
