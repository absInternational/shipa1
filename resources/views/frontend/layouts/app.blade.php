    ...
    <script>
        $(document).ready(function () {
            ...
            function validatePhoneInput(phoneInput) {
                ...
                if (phoneNumber.length >= 10) {
                    ...
                    if (!allowedPrefixes.includes(prefix)) {
                        alert(`Invalid phone number prefix: ${prefix}. Allowed prefixes only.`);
            ...
            $("#myForm").submit(function (e) {
                let phoneValid = validatePhoneInput(document.querySelector("#phone"));
                let phone2Valid = validatePhoneInput(document.querySelector("#phone2"));

                if (!phoneValid || !phone2Valid) {
