    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function validatePhoneNumber(phone) {
                let digits = phone.replace(/\D/g, ''); // Remove non-numeric characters
                if (digits.length === 10) {
                    let first3Digits = digits.substring(0, 3);
                ...
                $(".errPhone").text(""); // No error for incomplete numbers
                return false;
            }
            ...
            function setupIntlTelInput(e, n, t, o) {
                ...
                e.addEventListener("input", function() {
                    updateMask();
                    validatePhoneNumber(e.value);
                });

                e.addEventListener("blur", function() {
                    if (!t.isValidNumber() || !validatePhoneNumber(e.value)) {
