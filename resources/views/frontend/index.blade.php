@extends('frontend.layouts.app') @section('title', 'Trusted State to State Auto Transport Services in USA - SHIPA1') @section('meta_description', 'Best state to state auto transport services in USA for quick, safe & secure auto vehicle delivery. We focus on your satisfaction with reliable, affordable services.') @section('content')
<style>.card{background:#fff;border:1px solid #ddd;border-radius:5px;padding:15px;box-shadow:0 2px 5px rgba(0,0,0,.1)}.card .row{display:flex;flex-wrap:wrap}.card .col-6{width:50%}@keyframes custom-slides{from{transform:translateX(0)}to{transform:translateX(-80%)}}.input-field{width:50px;padding:5px;font-size:14px;border:none;outline:0}.input-field-1{width:65px;padding:0 0 0 10px;font-size:14px;border:none;outline:0}.form-wrap{margin-bottom:10px;position:relative}.form-label-outside{color:#fff;display:block;margin-bottom:5px}.err-style{color:red}.error-message{display:none;color:red}.error-field{border:2px solid red}.service-link{display:block;text-decoration:none;color:#fff}.service-link:hover{text-decoration:none}.service-link:hover .tj-service-item{box-shadow:0 4px 8px rgba(0,0,0,.2)}.service-link:hover .service-content{color:#8fc445}.service-link:hover .icon-box i{color:#fff}.project-link{display:block;position:relative;text-decoration:none;color:inherit;width:100%;height:100%}.tj-project-item{position:relative;overflow:hidden}.tj-project-item img{width:100%;height:auto;display:block}</style>
...
<a href="{{ route('vehicleTransportDetail') }}" aria-label="Learn more about vehicle transportation services" title="Vehicle Transportation Services" class=service-link>
...
<a class="btn btn-outline-secondary btn-sm ms-2 mt-2" aria-label="Learn more about vehicle transportation services" title="Vehicle Transportation Services" href="{{ route('vehicleTransportDetail') }}" style=background:#8fc445;color:#fff>
...
<p>Ship A1 is your trusted partner for safely and efficiently handling the toughest transportation challenges.</p>
<div class="d-flex justify-content-end">
<a class="btn btn-outline-secondary btn-sm ms-2 mt-2" aria-label="Learn more about Heavy transportation services" title="Heavy Transportation Services" href="{{ route('heavy-transport-detail') }}" style=background:#8fc445;color:#fff>
Read More<i class="bi bi-chevron-right"></i>
</a>
</div>
</div>
...
<a href="{{ route('freighttransport-detail') }}" aria-label="Learn more about freight transportation services" title="Freight Transportation Services" class=service-link>
<div class=tj-service-item data-bg-image="{{ asset('frontend/images/service/FREIGHT-CARD.webp') }}">
<div class=icon-box>
...
<div class="d-flex justify-content-end">
<a class="btn btn-outline-secondary btn-sm ms-2 mt-2" aria-label="Learn more about freight transportation services" title="Freight Transportation Services" href="{{ route('freighttransport-detail') }}" style=background:#8fc445;color:#fff>
Read More<i class="bi bi-chevron-right"></i>
</a>
</div>
</div>
...
<p class=desc>
No matter which mode of transportation you use, ShipA1 assures its customers, atmost security to their assets.
</p>
</div>
<div class=tj-icon-box>
<div class="ab-text d-flex align-items-center">
...
<p class=desc>
Our team is loaded with highly experienced professionals of both customer dealing and vehicle handling.
</p>
</div>
</div>
</div>
...
<div class=image-box>
<img class=p-z-idex src="{{ asset('/public/frontend/images/about/WMUD-Home.webp') }}" loading=lazy alt=Image>
</div>
<img class="group-1 p-z-idex" src="{{ asset('/public/frontend/images/about/about-3.webp') }}" loading=lazy alt=Image>
<img class=group-shape src="{{ asset('frontend/images/about/ab-shape.png') }}" loading=lazy alt=Image>
</div>
</div>
</div>
</div>
...
<p class=desc>ShipA1 has pledged to provide all-in-one auto transport solutions to all its customers and seeks your trust in return of our services.</p>
</div>
<div class=row>
...
<h4><a href="{{ route('frontend.pages.services.car-service') }}" aria-label="Learn more about Car Shipping Services" title="Car Shipping Services" class=title-link>Car Shipping Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Bike.webp') }}" alt="Motorcycle Shipping Service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.bike-service') }}" aria-label="Learn more about Motorcycle Shipping Services" title="Motorcycle Shipping Services" class=title-link>Motorcycle Shipping Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Heavy.webp') }}" alt="Heavy Transportation Services">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.heavy-service') }}" aria-label="Learn more about Heavy Transportation Services" title="Heavy Transportation Services" class=title-link>Heavy Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<h4><a href="{{ route('frontend.pages.services.roro-service') }}" aria-label="Learn more about Roro Shipping Services" title="Roro Shipping Services" class=title-link>Roro Shipping International</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Golf.webp') }}" alt="Golf Cart Transport Service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.golf-cart-service') }}" aria-label="Learn more about Golf Cart Transportation Services" title="Golf Cart Transportation Services" class=title-link>Golf Cart Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-ATV.webp') }}" alt="ATV/UTV Transport Service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.atv-utv-service') }}" aria-label="Learn more about ATV/UTV Transportation Services" title="ATV/UTV Transportation Services" class=title-link>ATV/UTV Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Construction.webp') }}" alt="Construction Transport Service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.construction-service') }}" aria-label="Learn more about Construction Transportation Services" title="Construction Transportation Services" class=title-link>Construction Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Farm.webp') }}" alt="Farm equipment Transport service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.farm-service') }}" aria-label="Learn more about Farm Transportation Services" title="Farm Transportation Services" class=title-link>Farm Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Excavator.webp') }}" alt="excavator Transport service">
<div class=arrow-icon>
<a href="{{ route('frontend.pages.services.excavator-service') }}" aria-label="Learn more about Excavator Shipping Services" title="Excavator Shipping Services"> <i class="fa-light fa-arrow-right"></i></a>
</div>
<div class=tj-project-content>
<span class=sub-title>EXCAVATOR</span>
<h4><a href="{{ route('frontend.pages.services.excavator-service') }}" aria-label="Learn more about Excavator Shipping Services" title="Excavator Shipping Services" class=title-link>Excavator Shipping Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/PYT-Commercial.webp') }}" alt="commercial transport service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.commercial-service') }}" aria-label="Learn more about Truck Transportation Services" title="Truck Transportation Services" class=title-link>Truck Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/reefer-truck-1.webp') }}" alt="Reefer Transport Service">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.reefer-service') }}" aria-label="Learn more about Reefer Transportation Services" title="Reefer Transportation Services" class=title-link>Reefer Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/7.webp') }}" alt="Hazmat Transportation Services">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.hazmat-service') }}" aria-label="Learn more about Hazmat Transportation Services" title="Hazmat Transportation Services" class=title-link>Hazmat Transportation Service</a></h4>
</div>
</a>
</div>
<div class=tj-project-item>
...
<img loading=lazy src="{{ asset('/public/frontend/images/project/5.webp') }}" alt="Dry van Transportation Services">
<div class=arrow-icon>
...
<h4><a href="{{ route('frontend.pages.services.dryvan-service') }}" aria-label="Learn more about Dry van Transportation Services" title="Dry van Transportation Services" class=title-link>Dry van Transportation Service</a></h4>
</div>
</a>
</div>
</div>
...
<ul class=list-gap>
<li><i class=flaticon-placeholder></i><a href="https://www.google.com/maps/place/201+International+Cir+STE+230,+Hunt+Valley,+MD+210301344,+USA/@39.4960629,-76.6603247,17z/data=!3m2!4b1!5s0x89c8128abe53a693:0xccf0052e1abf77f2!4m6!3m5!1s0x89c81261c3eae243:0x81e995e93023e64a!8m2!3d39.4960629!4d-76.6603247!16s%2Fg%2F11scxbqcdd?entry=ttu">201 International Cir STE 230, Hunt Valley, MD 21030-1344</a></li>
<li>
...
<div class="counter-item d-flex align-items-center" data-sal=slide-up data-sal-duration=800 data-sal-delay=300>
...
<div class="counter-item d-flex align-items-center" data-sal=slide-up data-sal-duration=800 data-sal-delay=400>
<div class=counter-icon>
...
<div class="counter-item d-flex align-items-center" data-sal=slide-up data-sal-duration=800 data-sal-delay=500>
<div class=counter-icon>
...
@include('partials.blog-slider') @include('partials.reveiw-detail') @include('partials.newsletter')
<script>document.addEventListener("DOMContentLoaded",(function(){const t=document.querySelector(".dropdown-toggle"),e=document.querySelector(".dropdown-menu");t.addEventListener("click",(function(t){e.classList.toggle("show"),t.stopPropagation()})),document.addEventListener("click",(function(n){t.contains(n.target)||e.contains(n.target)||e.classList.remove("show")}))}))</script>
@endsection