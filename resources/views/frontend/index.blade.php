...
delivery. We focus on your satisfaction with reliable, affordable services.') @section('content')<style>
    ...
    <section class="tj-slider-section">
        ...
        <div class="swiper sc-slider-1" data-autoplay="5000">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide d-flex position-relative text-white" style="height: 750px; background-size: cover; background-position: center;" data-bg-image="{{ asset('frontend/images/slider/DSF.webp') }}">
                ...
                <div class="swiper-slide d-flex position-relative text-white" style="height: 750px; background-size: cover; background-position: center;" data-bg-image="{{ asset('frontend/images/slider/home-slider-2.webp') }}">
                    <div class="container text-center">
                        <div class="slider-content p-z-idex">
                ...
                <div class="swiper-slide d-flex position-relative text-white" style="height: 750px; background-size: cover; background-position: center;" data-bg-image="{{ asset('frontend/images/slider/freight-banner-home.webp') }}">
                    <div class="container text-center">
                        <div class="slider-content p-z-idex">
            ...
            <div class="tj-project-item"><a href="{{ route('frontend.pages.services.excavator-service') }}"
                    ...
                    <div class="tj-project-content"><span class="sub-title">EXCAVATOR</span>
                        <h4><a href="{{ route('frontend.pages.services.excavator-service') }}"
                                aria-label="Learn more about Excavator Shipping Services"
                                title="Excavator Shipping Services" class="title-link">Excavator Shipping Service</a></h4>
                    </div>
                </a></div>
