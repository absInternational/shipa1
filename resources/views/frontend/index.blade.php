...
<input type="text" id="pickup-location" name="pickup-location" placeholder="Ex: 90005 Or Los Angeles"
required="" />
</div>
</div>
<div class="col-md-6">
...
<input type="text" id="delivery-location" name="delivery-location" placeholder="Ex: 90005 Or Los Angeles"
required="" />
</div>
</div>
</div>
