    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            sel.each(function(){
                ...
                var list = $('<ul />');
                var searchInput = $('<input type="text" class="searchInput" placeholder="Search..." style=" width: 100%; border: 1px solid #8fc445; padding: 8px;border-radius: 10px;">'); // Search input
