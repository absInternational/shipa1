        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-title text-center">Vehicle Transportation New York</h1>
                    <div class="breadcrumb-link">
                        ...
                        >
                        <span>
                            <span>Vehicle Transportation New York</span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="image-container">
                    <img class="img-fluid" src="{{ asset('/frontend/images/project/NY-Winter--.webp') }}"
                        loading="lazy" alt="Motorcyle Transport">
                </div>
                <br>
                <div class="text-container text-left">
                    <h3>Fast & Reliable New York Car Shipping Services</h3>
                    <p>How can you ship and transport cargo in a state that never sleeps? The most famous region and its 
                        locals never compromise on getting their car shipping delayed. ShipA1 has worked with the local 
                        transport service providers for more than a decade. We know how the market works in on-season 
                        and off-season times. Ready to get on-time New York Car shipping services.</p>
                </div>
                <div class="row mt-4">
    ...
    <div class="container">
            ...
            <div class="col-lg-8 col-md-12 order-sm-2 order-md-2 order-1 d-flex align-items-center justify-content-center sal-animate pt-4 mt-4" data-sal="slide-left" data-sal-duration="800">
                <div class="about-content-one">
                    <div class="tj-section-heading">
                        ...
                        data-sal-duration="800">Easy Car Shipping & Transport To New York </h3>
                        <p class="desc">Shifting in or near to the city of dreams? Have you checked in to ShipA1’s official
                            website? If not, then there is something waiting for you to grab. You can’t just hire a mediocre
                            service provider to freight your goods and vehicles in the New York states. There has to be a 
                            finest service provider like ShipA1.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row full-width mt-4 ms-1">
            <div class="col-12 custom-style">
                ...
                <p class=" text-center">ShipA1 provides high class and exclusive car transportation, offering standard enclosed
                    shipping. In terms of service, shipA1 offers door to door delivery, which transports the vehicle directly 
                    to your doorstep for maximum convenience, but terminal-based delivery can also be provided according to 
                    your preference. ShipA1 prioritizes comfort and luxury, having successfully accomplished hundreds of 
                    seamless vehicle transportation across America.</p>
...
<section class="tj-choose-us-section-service-cars-2 mt-4">
    <div class="container why-box">
        <div class="row services">
            <div class="col-12">
                <h2 class="services-h1">WHY CHOOSE US</h2>
            </div>
            <div class="col-12 col-md-4 mb-4">
                <div class="card- h-100">
                    <div class="card-body">
                        <h5 class="card-title text-dark">24/7 Customer Support</h5>
                        <p class="card-text text-dark">Your concern? Our priority. For ship a1 there is no odd time, we are present 24/7 for our customers</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 mb-4">
