...
@section('meta_description', 'Get excavator shipping services all over the USA, Get vehicle transport with secure and
safe along with insurance facility at nationwide - Shipa1.')
@section('content')
<Style>
    .title-2 {
        color: #8fc445;
        ...
        <div class="row">
                ...
                <div class="about-content-one">
                    <div class="tj-section-heading">
                        ...
                        <p class="desc">
                            ...
                            shipped easily by the company that is worthy of trust. Make sure to employ a transport
                            company with trained and certified
                            professionals. If there is any shipping company that you can trust, it has to be ShipA1
                            because of the experience it has
            ...
            <div class="col-lg-4 col-md-12 order-sm-1 order-md-2 order-2 d-flex align-items-center justify-content-center sal-animate" data-sal="slide-left" data-sal-duration="800">
                <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/excavator-1.webp') }}"
                            alt="Image">
                    </div>
                </div>
            </div>
    ...
    <div class="container pb-4">
        <div class="row">
            <div class="col-lg-4 col-md-12 order-sm-2 order-md-1 order-2 d-flex align-items-center justify-content-center sal-animate" data-sal="slide-left" data-sal-duration="800">
                <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/excavator-3.webp') }}"
                            alt="Image">
                    </div>
                </div>
            </div>
                ...
                <div class="about-content-one">
                    <div class="tj-section-heading">
                        ...
                        <p class="desc">
                            ...
                            the only
                            approach to get it transported ship A1 provides free online quotes through which you can get
                            the
                            exact shipping amount by putting in all these details. Hydraulic excavators are among the
                            most
    ...
    <div class="container pt-4">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 order-sm-1 order-md-2 order-2 d-flex align-items-center justify-content-center sal-animate" data-sal="slide-left" data-sal-duration="800">
                <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/excavator-2.webp') }}"
                            alt="Image">
                    </div>
                </div>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card- h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-light">The first and foremost thing you need to mention is the size,
                            weight etc and will determine
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card- h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-light">You should expect to pay a price slightly higher than other
                            vehicles in all
                            the heavy equipments as they are bigger in size and needs utmost care to be delivered
                            safely.</p>
                    </div>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card- h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-light">Because of the vehicle’s dimension it takes proper due
                            diligence in order to make the delivery.
                            Due to that it takes ample time for your delivery to get done & you must expect that.</p>
                    </div>
                </div>
