...
<section class="tj-about-section pt-4 pb-0">
        <div class="container">
            <div class="row">
                ...
                <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/heavy-service1.webp') }}" alt="Image">
                    </div>
                </div>
            </div>
            </div>
    ...
    <section class="tj-about-section pt-0 pb-0">
        <div class="container">
            ...
            <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/heavy-service2.webp') }}" alt="Image">
                    </div>
                </div>
            </div>
    ...
    <section class="tj-about-section pt-0 pb-0">
        <div class="container">
            <div class="row">
                ...
                <div class="mt-4 rounded">
                    <div class="image-box">
                        <img class="rounded" src="{{ asset('frontend/images/project/heavy-service3.webp') }}" alt="Image">
                    </div>
                </div>
            </div>
            </div>
