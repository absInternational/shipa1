...
Route::prefix('marketing')->group(function () {
    ...
    Route::get('/vehicle-Transportation-In-Hampshire', [FrontendController::class, 'vehicleTransportInHampshire'])->name('frontend.pages.marketing.vehicleTransportInHampshire');
});
